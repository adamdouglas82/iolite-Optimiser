...
### Step 1.3: Apply Washout
1.  Review the **FW 0.1M (10%)** statistics in the left panel.
2.  Decide which metric to use:
    - **Average**: Best for stable, well-behaved systems.
    - **Max**: Conservative; ensures zero signal overlap even for the slowest washout event.
3.  Click **Apply Average (or Max) to Optimiser**. This sends the value directly to the Optimiser tab.
